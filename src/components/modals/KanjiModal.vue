  ...
  <Transition name="fade">
    <div v-if="isOpen && kanji" class="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
        <!-- Header with Kanji -->
        <div
          class="relative bg-tanuki-green text-white p-8 pb-12 flex flex-col items-center shrink-0"
        >
          <button
            @click="emit('close')"
          ...
          <!-- Tab Navigation -->
          <div
            class="absolute bottom-0 left-0 right-0 flex justify-center translate-y-1/2 px-6 z-10"
          >
        ...
        <div class="p-8 pt-12 overflow-y-auto bg-white flex-1">
          ...
          <div
            ...
            class="flex flex-col items-center animate-fadeIn min-h-75"
          >
          ...
          <div v-else class="space-y-8 animate-fadeIn">
            ...
            <div class="flex justify-center gap-4">
              <span
                class="bg-tanuki-beige px-3 py-1 rounded-full text-tanuki-brown text-sm font-bold"
            ...
            <div class="grid grid-cols-2 gap-4">
              ...
              >
                <div
                  class="text-xs font-bold text-tanuki-green-light uppercase tracking-widest mb-2"
                >
                  Kunyomi
                </div>
            ...
            <!-- Examples Section -->
            <div
              v-if="kanji.examples && kanji.examples.length > 0"
            ...
            >
              ...
              <div class="space-y-3">
                <div
                  v-for="(ex, idx) in kanji.examples"
                  :key="idx"
                ...
                >
                  ...
                  <button
                    @click="playExample(ex.reading, idx)"
