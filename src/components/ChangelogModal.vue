      ...
      >
        ...
        >
          ...
          <div class="relative z-10">
            <h2 class="text-4xl font-display font-bold !text-tanuki-beige">Notes de version</h2>
        ...
        <div class="overflow-y-auto p-4 md:p-6 space-y-8 overscroll-contain">
          ...
          >
            ...
            <div class="flex items-baseline gap-3 mb-4">
              ...
              <span
                v-if="changelog[0] && release.version === changelog[0].version"
                  ...
                  >
                    ...
                    <span
                      v-html="
                        item.replace(
                          /^([^:]+):/,
                          '<strong class=\'text-tanuki-brown-dark font-bold uppercase tracking-wide\'>$1</strong> :',
                        )
                      "
                    ></span>
                  </li>
