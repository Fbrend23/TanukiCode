...
<template>
  <div class="card p-4 flex items-center gap-4 w-full relative group">
    ...
    <div class="grow flex flex-col gap-1 z-10">
      <div class="flex justify-between items-end mb-1">
        ...
        >
          ...
          >
            ...
            <div
              class="absolute -bottom-1 left-1/2 -translate-x-1/2 w-2 h-2 bg-tanuki-brown-dark rotate-45"
            ></div>
          </div>
        </span>
      ...
      <div
        class="h-4 bg-gray-200 rounded-full overflow-hidden shadow-inner border border-gray-100 relative"
      >
        <div
          class="h-full bg-linear-to-r from-tanuki-gold to-yellow-400 transition-all duration-1000 ease-out relative"
      ...
      <p class="text-[10px] text-gray-400 text-right mt-1">
        ...
        {{ Math.ceil(currentLevelProgress.total - currentLevelProgress.current) }} XP
      </p>
    </div>
  </div>
</template>
