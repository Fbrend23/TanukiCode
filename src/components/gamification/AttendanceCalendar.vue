...
const labelSize = computed(() =>
  selectedYear.value === 'recent' ? 'h-5 leading-5' : 'h-3 leading-3',
)
...
const getLevelColor = (level: number) => {
  switch (level) {
    ...
    case 1:
      return 'bg-tanuki-green/30 border-tanuki-green/20' // light green
    case 2:
      return 'bg-tanuki-green/50 border-tanuki-green/40'
    case 3:
      return 'bg-tanuki-green/80 border-tanuki-green/60'
    case 4:
      return 'bg-tanuki-green border-tanuki-green-dark'
    default:
      return 'bg-gray-100'
  }
}
  ...
  <div class="card p-2 md:p-3 w-full overflow-hidden">
      ...
      <button
        ...
        :class="
          selectedYear === 'recent'
            ...
            : 'bg-white text-gray-500 border-gray-200 hover:border-tanuki-green hover:text-tanuki-green'
        "
    ...
    <div class="overflow-x-auto pb-2 pt-10 -mx-2 px-2">
      <div class="flex gap-1 min-w-max">
        <!-- Days of week labels -->
        <div
          class="grid grid-rows-7 gap-1 text-[9px] text-gray-400 font-bold items-center pr-2 pt-px"
        >
        ...
        <div class="grid grid-rows-7 gap-1 grid-flow-col">
          <div
            ...
            :class="[
              cellSize,
              'rounded border transition-all hover:scale-125 relative hover:z-10 cursor-pointer',
