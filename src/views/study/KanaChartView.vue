  ...
  <div>
    <div class="flex flex-col items-center w-full px-4">
      ...
      <div v-else class="flex flex-col items-center w-full">
        ...
        <!-- Tab Navigation -->
        <div
          class="flex gap-2 mb-6 overflow-x-auto max-w-full px-1 py-1 text-sm md:text-base scrollbar-hide"
        >
          <button
        ...
        <!-- Progress Bar -->
        <MasteryBar
          :label="`Progression ${mode === 'hiragana' ? 'Hiragana' : 'Katakana'}`"
          :current="kanaMastered"
          :total="kanaTotal"
          class="mb-4"
        />
