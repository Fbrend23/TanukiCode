  ...
  <div class="flex flex-col items-center w-full px-4 py-0 pb-24 font-outfit">
    ...
    <template v-else>
      <div class="flex flex-col items-center w-full max-w-6xl mb-6">
        <div class="text-center mb-6">
          ...
          <!-- TABS -->
          <div
            class="card flex p-1 shadow-none border-2 border-tanuki-green bg-white inline-flex cursor-default"
          >
            <button
          ...
          <div class="relative w-full max-w-2xl flex flex-col md:block gap-2 mb-6 mx-auto">
            ...
            <div class="relative w-full max-w-md mx-auto z-10">
              ...
              <input
                v-model="searchQuery"
                type="text"
                placeholder="Rechercher (Chat, Inu...)"
                class="search-bar"
              />
            </div>
            ...
            >
              <button
                ...
                class="btn-filter md:w-auto w-full max-w-md"
              >
          ...
          >
            ...
            >
              ...
              <div class="flex flex-col items-center justify-center grow py-2">
                ...
                <p
                  v-if="word.reading !== word.word"
                  class="text-sm text-tanuki-brown/80 mb-1 font-japanese"
                >
                  {{ word.reading }}
                </p>
        ...
        >
          <div class="relative w-full max-w-2xl flex flex-col md:block gap-2 mb-6 mx-auto">
            ...
            >
              <button
                @click="isSentenceFilterModalOpen = true"
                class="btn-filter md:w-auto w-full max-w-md"
              >
                <Settings2 class="w-5 h-5" />
                <span>Filtres</span>
                <div
                  v-if="selectedSentenceCategories.length > 0"
                  class="w-2 h-2 rounded-full bg-tanuki-gold"
                ></div>
              </button>
            </div>
    ...
    <FilterModal v-model:isOpen="isSentenceFilterModalOpen">
      <div class="flex flex-col gap-3">
        ...
        <div class="flex flex-wrap gap-2">
          <button
            v-for="cat in sentenceCategories"
            :key="cat"
            @click="toggleSentenceCategory(cat as string)"
            :class="[
