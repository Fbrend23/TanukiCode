        ...
        <div v-if="activeTab === 'profile'" class="space-y-6 animate-fade-in">
          ...
          <div class="grid grid-cols-3 gap-4">
            <div class="card p-4 flex flex-col items-center justify-center gap-2 text-center">
              ...
              <p class="text-[10px] font-bold text-tanuki-brown/50 uppercase tracking-wide">
                Score
              </p>
            ...
            <div class="card p-4 flex flex-col items-center justify-center gap-2 text-center">
              ...
              <p class="text-xl lg:text-2xl font-bold text-tanuki-brown">
                {{ userStore.streak }}
                <span class="text-xs font-normal text-tanuki-brown/60">j</span>
              </p>
            </div>
            <div class="card p-4 flex flex-col items-center justify-center gap-2 text-center">
