  ...
  <div class="flex flex-col items-center justify-center min-h-[70vh] px-4">
    <div class="w-full max-w-md card p-8">
      <div class="flex flex-col items-center mb-8">
        ...
        <p class="text-gray-500 text-center mt-2">Choisissez un nouveau mot de passe sécurisé.</p>
      </div>

      <form @submit.prevent="handleUpdatePassword" class="space-y-4">
        <div>
          <label for="new-password" class="block text-sm font-bold text-tanuki-brown mb-1"
        ...
        <div>
          <label for="confirm-password" class="block text-sm font-bold text-tanuki-brown mb-1"
            >Confirmer</label
          >
          <div class="relative">
