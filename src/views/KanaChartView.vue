    ...
    <div class="flex flex-col items-center">
        ...
        <div class="grid grid-cols-5 gap-2 md:gap-4 max-w-2xl w-full p-4">
            <div v-for="(item, index) in currentKana" :key="index" @click="playSound(item.char)"
                class="aspect-square flex flex-col items-center justify-center bg-white rounded-2xl shadow-md border-2 border-tanuki-green hover:shadow-lg hover:bg-tanuki-beige/20 transition-all cursor-pointer group relative overflow-hidden">
