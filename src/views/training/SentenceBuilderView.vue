            ...
            <div>
              ...
              <div class="grid grid-cols-2 gap-3">
                <button
                  ...
                  :class="
                    displaySettings.tokenMode === mode
                ...
                >
                  ...
                  <div
                    v-if="displaySettings.tokenMode === mode"
        ...
        >
          ...
          <div class="mb-2 md:mb-6 flex flex-col items-center w-full">
            ...
            <div class="mt-2 min-h-[2rem] flex items-center justify-center">
              <button
                v-if="!showHint && !isCorrect && mistakeCount < 3"
                @click="showHint = true"
          ...
          <div
            class="w-full min-h-[80px] md:min-h-[100px] border-b-2 border-tanuki-brown/20 mb-1 md:mb-4 flex flex-wrap gap-1 md:gap-1.5 justify-center items-center pb-2 transition-colors"
            :class="[
              isCorrect ? 'border-tanuki-green' : '',
              hasChecked && !isCorrect ? 'border-red-300 bg-red-50/50' : '',
            ]"
          >
            <p
              v-if="answerTokens.length === 0"
              class="text-gray-300 italic text-sm mb-2 select-none"
            >
            ...
            <div
              ...
              :class="[
                roundTokenMode === 'kana'
                  ? 'font-japanese font-medium text-base md:text-xl'
          ...
          <div
            class="mb-1 transition-opacity duration-300 min-h-[1.2rem]"
            :class="
              hasChecked && !isCorrect ? 'opacity-100' : 'opacity-0 select-none pointer-events-none'
            "
          >
            <span
              class="text-red-500 font-bold animate-bounce-short inline-block text-xs md:text-base"
            >
              {{
                mistakeCount >= 3
                  ? 'Dommage ! La série est perdue.'
