...
<template>
  <main
    class="grow container mx-auto py-1 md:py-8 flex flex-col items-center px-4 w-full max-w-4xl"
  >
    <!-- Loading State -->
    ...
    <div v-else class="w-full flex flex-col items-center">
      <div class="relative w-full mb-4 md:mb-8 flex flex-col items-center py-6 md:py-10">
        ...
        >
          <img
            src="@/assets/tanuki-mascot.png"
            alt="Tanuki Mascot"
            class="h-48 md:h-80 object-contain"
          />
        </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full">
        ...
        >
          <div class="absolute -right-4 -top-4 opacity-5 font-display text-9xl text-tanuki-brown">
            あ
          </div>
          <div
            v-if="authStore.user"
          ...
          <h3
            class="text-xl font-bold text-tanuki-brown group-hover:text-tanuki-green transition-colors"
          >
            Kanas
          </h3>
          ...
          <div
            v-if="authStore.user"
            class="w-full h-2 bg-gray-100 rounded-full overflow-hidden mt-auto"
          >
            <div
              class="h-full bg-blue-500 transition-all duration-500"
              :style="{ width: getPercentage(kanaProgress) + '%' }"
            ></div>
          </div>
        </RouterLink>
        ...
        >
          ...
          <div
            class="bg-red-100 p-3 rounded-full mb-3 group-hover:bg-red-200 transition-colors z-10"
          >
          ...
          <div
            v-if="authStore.user"
            class="w-full h-2 bg-gray-100 rounded-full overflow-hidden mt-auto z-10"
          >
            <div
              class="h-full bg-red-500 transition-all duration-500"
              :style="{ width: getPercentage(kanjiProgress) + '%' }"
            ></div>
          </div>
        </RouterLink>
        ...
        >
          ...
          <div
            class="bg-indigo-100 p-3 rounded-full mb-3 group-hover:bg-indigo-200 transition-colors"
          >
          ...
          >
            <div
              ...
              :style="{ width: getPercentage(grammarProgress) + '%' }"
            ></div>
          </div>
        </RouterLink>
        ...
        >
          ...
          <div
            class="bg-green-100 p-3 rounded-full mb-3 group-hover:bg-green-200 transition-colors"
          >
          ...
          >
            <div
              ...
              :style="{ width: getPercentage(vocabProgress) + '%' }"
            ></div>
          </div>
        </RouterLink>
        ...
        >
          ...
          <div
            class="bg-orange-100 p-3 rounded-full mb-3 group-hover:bg-orange-200 transition-colors"
          >
          ...
          >
            <div
              ...
              :style="{
                width:
                  (userStore.masteredItems.length /
                    (kanaProgress.total +
                      vocabProgress.total +
                      kanjiProgress.total +
                      grammarProgress.total)) *
                    100 +
                  '%',
              }"
            ></div>
