...
export const kanjiList: Kanji[] = [
  ...
  // Missing N5 Kanjis - Time & Abstract
  {
    character: '今',
    onyomi: ['コン', 'キン'],
    kunyomi: ['いま'],
  ...
  },
  {
    ...
    examples: [
      ...
      { word: '来週', reading: 'らいしゅう', meaning: 'La semaine prochaine' },
    ],
    strokes: 11,
    jlpt: 5,
  },
  {
    ...
    onyomi: ['カン', 'ケン'],
    kunyomi: ['あいだ', 'ま'],
    meaning: ['Intervalle', 'Espace', 'Entre'],
    category: 'Time',
    examples: [
      { word: '時間', reading: 'じかん', meaning: 'Temps / Heure' },
      { word: '人間', reading: 'にんげん', meaning: 'Humain' },
    ],
    strokes: 12,
    jlpt: 5,
  },
  {
    ...
    examples: [
      ...
      { word: '一時', reading: 'いちじ', meaning: 'Une heure' },
    ],
    strokes: 10,
    jlpt: 5,
  },
  ...
  },
  {
    ...
    examples: [
      ...
      { word: '三時半', reading: 'さんじはん', meaning: '3h30' },
    ],
    strokes: 5,
    jlpt: 5,
  },
  {
    ...
    onyomi: ['ブン', 'フン', 'ブ'],
    kunyomi: ['わ.ける', 'わ.かる'],
    meaning: ['Partie', 'Minute', 'Comprendre'],
    category: 'Time',
    examples: [
  ...
  // Colors
  {
    ...
    category: 'Adjectives',
    examples: [
      { word: '赤い', reading: 'あかい', meaning: 'Rouge (adj)' },
  ...
  },
  {
    ...
    category: 'Adjectives',
    examples: [
      { word: '青い', reading: 'あおい', meaning: 'Bleu (adj)' },
      { word: '青空', reading: 'あおぞら', meaning: 'Ciel bleu' },
    ],
    strokes: 8,
    jlpt: 5,
  },
  {
    ...
    category: 'Adjectives',
    examples: [
      { word: '黒い', reading: 'くろい', meaning: 'Noir (adj)' },
      { word: '黒板', reading: 'こくばん', meaning: 'Tableau noir' },
    ],
    strokes: 11,
    jlpt: 5,
  },
  ...
  },
  {
    ...
    examples: [
      ...
      { word: '言葉', reading: 'ことば', meaning: 'Mot / Langage' },
    ],
    strokes: 7,
    jlpt: 5,
  },
  // Nature & Places
  {
    ...
    examples: [
      { word: '花火', reading: 'はなび', meaning: "Feu d'artifice" },
      { word: '花見', reading: 'はなみ', meaning: 'Hanami (Regarder les fleurs)' },
    ],
    strokes: 7,
    jlpt: 5,
  },
  {
    ...
    category: 'Nature',
    examples: [
      { word: '魚', reading: 'さかな', meaning: 'Poisson' },
      { word: '金魚', reading: 'きんぎょ', meaning: 'Poisson rouge' },
    ],
    strokes: 11,
    jlpt: 5,
  },
  {
    ...
    examples: [
      ...
      { word: '売店', reading: 'ばいてん', meaning: 'Kiosque' },
    ],
    strokes: 8,
    jlpt: 5,
  },
  {
    ...
    onyomi: ['ドウ'],
    kunyomi: ['みち'],
    meaning: ['Chemin', 'Route', 'Voie'],
    category: 'Places',
    examples: [
      { word: '道', reading: 'みち', meaning: 'Route' },
      { word: '書道', reading: 'しょどう', meaning: 'Calligraphie' },
    ],
    strokes: 12,
    jlpt: 5,
  },
  // Action Verbs
  {
    ...
    category: 'Verbs',
    examples: [
      { word: '会う', reading: 'あう', meaning: 'Rencontrer' },
      { word: '会社', reading: 'かいしゃ', meaning: 'Entreprise' },
    ],
    strokes: 6,
    jlpt: 5,
  },
  {
    ...
    examples: [
      ...
      { word: '休み', reading: 'やすみ', meaning: 'Vacances / Pause' },
    ],
    strokes: 6,
    jlpt: 5,
  },
  ...
  },
  {
    ...
    category: 'Verbs',
    examples: [
      { word: '立つ', reading: 'たつ', meaning: 'Se lever' },
